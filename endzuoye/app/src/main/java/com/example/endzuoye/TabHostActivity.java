...
public class TabHostActivity extends TabActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //tab_host.addTab(getNewTab(FIRST_TAG, R.string.menu_first, R.drawable.tab_first_selector, ShoppingChannelActivity.class));
        ...
        tab_host.addTab(getNewTab(SECOND_TAG, R.string.menu_second,
                R.drawable.tab_second_selector, ShoppingCartProActivity
                        .class));
